...
const SearchInput = ({ currentTag, keyword, cRef,className }) => {
  ...
  return <div className='flex w-full '
        ...
        <input
            ...
            className={`${className} outline-none w-full text-sm pl-4 transition focus:shadow-lg font-light leading-10 text-black bg-opacity-50 md:bg-opacity-100 bg-neutral-100 md:hover:bg-neutral-200 md:focus:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 dark:text-white`}
            onKeyUp={handleKeyUp}
            onFocus={handleFocus}
