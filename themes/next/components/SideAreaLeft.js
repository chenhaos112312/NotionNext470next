  ...
  return (
    <aside
      ...
      <section className='w-60'>
        {/* 菜单 */}
        {/* <section className='shadow hidden lg:block mb-5 pb-4 bg-white dark:bg-hexo-black-gray hover:shadow-xl duration-200'> --ed*/} 
    
        <section className='shadow hidden lg:block mb-5 pb-4 bg28 rounded-xl hover:shadow-xl duration-200'>
          ...
          {siteConfig('NEXT_MENU_SEARCH', null, CONFIG) && (
            <div className='px-2 pt-2 '>
              <SearchInput className="rounded-full" {...props} />
            </div>
          )}
        </section>
      </section>
      ...
      <div className='sticky top-4 hidden lg:block'>
        <Card>
          <Tabs>
            {showToc && (
            //  className='dark:text-gray-400 text-gray-600 bg-white dark:bg-hexo-black-gray duration-200 --ed'>
              <div
                key={locale.COMMON.TABLE_OF_CONTENTS}
                className='dark:text-gray-400 text-gray-600 bg28 duration-200'>
                <Toc toc={post.toc} />
              </div>
            )}

            {/* className='mb-5 bg-white dark:bg-hexo-black-gray duration-200 py-6'> --ed*/}
            <div
              key={locale.NAV.ABOUT}
              className='mb-5 bg28 duration-200 py-6'>
              <InfoCard {...props} />
              <>
